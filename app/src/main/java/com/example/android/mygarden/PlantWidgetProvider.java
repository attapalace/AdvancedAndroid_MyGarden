...
public class PlantWidgetProvider extends AppWidgetProvider {
    ...
    static void updateAppWidget(Context context, AppWidgetManager appWidgetManager,
                                int imgRes, int appWidgetId,long plantId , boolean showWaterBtn) {
        ...
        views.setTextViewText(R.id.plant_id , String.valueOf(plantId));

        if (showWaterBtn) views.setViewVisibility(R.id.water_button, View.VISIBLE);
    ...
    public static void updatePlantWidgets(Context context, AppWidgetManager appWidgetManager,
                                          int imgRes, int[] appWidgetIds,long plantId,boolean showWaterBtn) {
        for (int appWidgetId : appWidgetIds) {
            updateAppWidget(context, appWidgetManager, imgRes, appWidgetId,plantId , showWaterBtn);
        }
    }
